...
# Packages for manipulating raster
import rioxarray as rxr
from osgeo import gdal

# Packages for changing values of raster
from valueChange import nc_to_tiff, value_sea_change, convert_to_asc
# ---------------------------------------------------------------------------------------------------------------------
...
def dem_raster(resolution_func, chunk_size_func, processor_func,
    ...
    instruction_json['dem'] = {
        ...
        "general": {
            ...
            # "bathymetry_points_z_label": ['bed_elevation_Neal_et_al', "depths", "elevation", "elevation"]
