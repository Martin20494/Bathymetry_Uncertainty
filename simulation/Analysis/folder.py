...
MAIN_DIR = f"S:\\Bathymetry\\versions010\\{version}"
...
new_wse_csv_bathy = f"{MAIN_DIR}\\5_analysis\\new_wse\\bathy_csv"
new_wse_raster_bathy = f"{MAIN_DIR}\\5_analysis\\new_wse\\bathy_raster"
new_wse_plot_bathy = f"{MAIN_DIR}\\5_analysis\\new_wse\\bathy_plot"

# Elevation
elev_csv_bathy = f"{MAIN_DIR}\\5_analysis\\elev\\bathy_csv"
elev_raster_bathy = f"{MAIN_DIR}\\5_analysis\\elev\\bathy_raster"
elev_plot_bathy = f"{MAIN_DIR}\\5_analysis\\elev\\bathy_plot"

# Manning's n
n_csv_bathy = f"{MAIN_DIR}\\5_analysis\\n\\bathy_csv"
n_raster_bathy = f"{MAIN_DIR}\\5_analysis\\n\\bathy_raster"
n_plot_bathy = f"{MAIN_DIR}\\5_analysis\\n\\bathy_plot"
